                ...
                <form method="POST" enctype="multipart/form-data" class="row" id="create-from-banner">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <input type="text" name="links" class="form-control" placeholder="Chọn link sự kiện ...">
                        </div>
                        <div class="col-12 mb-2">
                    ...
                    <div class="col-6">
                        ...
                        <div class="mt-3">
                            ...
                            <img src="{{ asset('frontend/image/no_image.png') }}" alt="" id="uploaded_image" style="margin: 0 auto; margin-top: 10px; border-radius: 10px;max-height: 200px;object-fit: cover;">
                            <input type="hidden" name="image" value="" id="base_path">
                        </div>
                    </div>
