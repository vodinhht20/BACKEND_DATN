    ...
    <div class="table-border-style">
        <div class="table-responsive scrollbar-custom">
            <table class="table align-middle-td">
                ...
                <tbody>
                    @foreach ($workSchedules['departmentData'] as $workSchedule)
                        <tr>
                            <td>#{{ $workSchedule->id }}</td>
                            <td>{{ $workSchedule->name }}</td>
                            <td>{{ $workSchedule->department ? $workSchedule->department->name : 'N/A' }}</td>
                            <td>
                    ...
                    @endforeach
                    @if (count($workSchedules['departmentData']) == 0)
                        <tr>
        ...
        <div style="float: right;">
            {{ $workSchedules['departmentData']->appends(request()->query())->links() }}
        </div>
    </div>
</div>