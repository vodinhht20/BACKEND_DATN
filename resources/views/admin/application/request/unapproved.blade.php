<div>
    <div class="mt-5 mb-2 row">
        <div class="col-4">Có <b>@{{ requestUnapprovedData.total }}</b> lịch làm việc trong danh sách</div>
    </div>
</div>
<div class="table-border-style mt-2">
    <div class="table-responsive scrollbar-custom" style="width:100%;">
        <table class="table align-middle-td">
            ...
            <tbody>
                <tr v-for="(record, index) in requestUnapprovedData.data">
                    <td>@{{ index+1 }}</td>
                ...
                <tr v-if="requestUnapprovedData.total == 0">
    ...
    <div style="float: right;" class=""  v-if="requestUnapprovedData.total > 0">
        <template>
            <paginate
                :page-count="requestUnapprovedData.last_page"
                v-model="requestUnapprovedData.current_page"
                :initial-page="requestUnapprovedData.current_page"
                :click-handler="changePageUnapp"
                :prev-text="'‹'"
                :next-text="'›'"
