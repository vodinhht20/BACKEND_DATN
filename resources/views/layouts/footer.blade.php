<footer class="mt-5">
    <div class="box-footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12 mailchimp-footer">
                ...
                <div class="col-lg-4 col-md-6 col-12 about-footer">
                    ...
                    <img class="decor-oranger"src="{{asset('frontend')}}/image/img-orange.png" alt="">
                </div>
                <div class="col-lg-4 col-md-6 col-12 mt-20 contact-footer">
                    <h3>LIÊN HỆ VỚI CHÚNG TÔI</h3>
                    <p><b>Địa chỉ:</b> Số 1, Trịnh Văn Bô, Nam Từ Liêm, Hà Nội</p>
                    <p><b>Điện thoại: </b> 0329766459</p>
                    <p><b>Email:</b> vodinh2000ht@gmail.com</p>
                </div>
            </div>
        </div>
    </div>
